...
REVOKE ALL ON FUNCTION public.get_top_products_by_days(integer, integer) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_top_products_by_days(integer, integer) FROM anon;
...
REVOKE ALL ON FUNCTION public.get_top_offer_boxes_by_days(integer, integer) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_top_offer_boxes_by_days(integer, integer) FROM anon;
