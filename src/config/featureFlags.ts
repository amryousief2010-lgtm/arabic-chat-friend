...
export const FEATURE_FLAGS = {
   ...
   * أو مصنع اللحوم. Kill-switch إضافي فوق allow_manual_warehouse_stock_addition:
   * عند الإيقاف يختفي زر الإضافة من المخزن الرئيسي فقط، وتبقى الحركات
   * اليدوية القديمة محفوظة في سجل الحركات.
   */
  ...
  /**
   * مؤقتًا: السماح بصرف منتجات يدوي / توريد مباشر للجهات (فرع العجوزة،
   * مندوب خاص، هيلثي تيست، كارفور، عميل، تالف، استخدام داخلي، أخرى) من
   * المخزن الرئيسي بدون إنشاء تحويل داخلي أو فاتورة أو حركة خزنة. عند
   * الإيقاف يختفي زر "صرف منتجات / توريد للجهات"، وتبقى الحركات القديمة
   * محفوظة في سجل الحركات.
   */
