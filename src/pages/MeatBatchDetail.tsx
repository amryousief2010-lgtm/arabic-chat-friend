...
import { ArrowRight, Loader2, Factory, AlertTriangle, Printer } from "lucide-react";
  ...
  return (
    <div dir="rtl" className="p-4 md:p-6 space-y-4">
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <Button size="sm" variant="outline" onClick={() => exportBatchPDF({ factory: "Meat Factory", batch, consumption: cons, packaging: pack, movements: movs, audit })}>
