...
const updates: UpdateEntry[] = [
  {
    date: "2026-06-11",
    type: "feature",
    title: "تحويل خزنة المعمل → الخزنة الرئيسية للمجزر (بدلاً من خزنة العهدة)",
    description: "تم تعديل وجهة التحويل من خزنة المعمل لتذهب مباشرة إلى الخزنة الرئيسية للمجزر بدلاً من خزنة العهدة. الزر أصبح \"تحويل إلى الخزنة الرئيسية للمجزر\". عند التسجيل: يُخصم المبلغ فورًا من خزنة المعمل ويتم إنشاء حركة وارد بحالة pending_approval على الخزنة الرئيسية، ولا تتأثر خزنة العهدة نهائيًا. كارت \"تحويلات واردة من خزنة المعمل\" تم نقله من صفحة خزنة العهدة إلى صفحة الخزنة الرئيسية للمجزر، ولا يزيد رصيد الرئيسية فعليًا إلا بعد تأكيد الاستلام من محمد شعلة أو المدير. تم اختبار الدورة بمبلغ 30,000 جنيه وتأكيد عدم تأثر خزنة العهدة وعكس حركات الاختبار بالكامل.",
    module: "الخزن والمجزر",
    icon: Wrench,
  },
  {
    date: "2026-06-08",
  ...
  },
  {
    date: "2026-05-29",
    type: "feature",
    title: "توسعة صلاحيات المجزر + مخازن العملاء (هايبر هيلثي تيست وكارفور)",
    description: "أُضيف لأحمد خاطر دور إضافي \"مدير المجزر\" بجوار صلاحياته كأمين مخزن العجوزة، فأصبح يدير تقسيمة الذبح ويحوّل المنتجات للمخزن الرئيسي عند هادي. أُضيف مخزنان جديدان تحت إدارة هادي: \"هايبر هيلثي تيست\" و\"هايبر كارفور\"، يدعمان تسجيل التوريد (يُخصم من المخزن الرئيسي ويُضاف للمخزن العميل) والمرتجع (العكس)، مع شاشتين تعرضان الرصيد الحالي وسجل آخر 200 حركة. كذلك دعم النظام الآن لتعدد الأدوار لكل مستخدم بشكل صحيح (السايدبار والصلاحيات يأخذان كل أدوار المستخدم في الحسبان).",
    module: "المجزر والمخازن",
    icon: Beef,
  },
  {
    date: "2026-05-29",
