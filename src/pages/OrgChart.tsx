...
const salesTeam: Member[] = [
  { name: "آية", title: "موظف مبيعات 1" },
  { name: "نورا", title: "موظف مبيعات 2" },
  { name: "هاجر", title: "موظف مبيعات 3" },
  { name: "مريم", title: "موظف مبيعات 4" },
  { name: "فاطمة", title: "موديريتور مبيعات — مكتب العجوزة" },
];
