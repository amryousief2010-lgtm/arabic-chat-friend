...
const HRWorkforceAnalysis = lazy(() => import("@/pages/hr/HRWorkforceAnalysis"));
const HRPayDay1Report = lazy(() => import("@/pages/hr/HRPayDay1Report"));
const Warehouses = lazy(() => import("@/pages/modules/Warehouses"));
const WarehouseManagementHub = lazy(() => import("@/pages/modules/WarehouseManagementHub"));
...
const ManufacturingInvoiceDetail = lazy(() => import("@/pages/meat/ManufacturingInvoiceDetail"));
      ...
      <Suspense fallback={<RouteFallback />}>
        <Routes location={location} key={location.pathname}>
          ...
          <Route path="/.lovable/oauth/consent" element={
            <PageTransition><OAuthConsent /></PageTransition>
          } />
          ...
          */}
          ...
          <Route path="/hagar-orders-review" element={
            <ProtectedRoute allowedRoles={['general_manager', 'executive_manager', 'sales_moderator']}>
              <PageTransition><HagarOrdersReview /></PageTransition>
            </ProtectedRoute>
          } />
          ...
          <Route path="/feed-factory/historical-reference" element={
            <ProtectedRoute allowedRoles={['general_manager', 'executive_manager', 'feed_factory_manager', 'accountant', 'financial_manager']}>
          ...
          <Route path="/meat-factory/manufacturing/:id" element={
            <ProtectedRoute allowedRoles={['general_manager', 'executive_manager', 'meat_factory_manager', 'production_manager', 'accountant', 'financial_manager']}>
              <PageTransition><ManufacturingInvoiceDetail /></PageTransition>
            </ProtectedRoute>
          } />
          ...
          <Route path="/hr/workforce-analysis" element={
            <ProtectedRoute allowedRoles={['general_manager', 'executive_manager', 'hr_manager', 'accountant', 'financial_manager']}>
