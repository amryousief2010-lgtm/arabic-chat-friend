...
export const moduleSections: ModuleSection[] = [
  {
    ...
    items: [
      ...
      { icon: ScrollText, label: "سجل التحديثات", path: "/updates-log", roles: ['general_manager', 'executive_manager', 'sales_manager', 'accountant', 'warehouse_supervisor', 'production_manager', 'marketing_sales_manager', 'financial_manager', 'quality_manager', 'farm_manager', 'hatchery_manager', 'brooding_manager', 'slaughterhouse_manager', 'meat_factory_manager', 'feed_factory_manager', 'hr_manager'] },
  ...
  },
  {
    ...
    icon: Warehouse,
    label: "9. المخازن",
    roles: ['general_manager', 'executive_manager', 'warehouse_supervisor', 'production_manager', 'quality_manager', 'sales_manager', 'sales_moderator', 'marketing_sales_manager'],
    items: [
      ...
      { icon: Warehouse, label: "متاح آية", path: "/warehouse-stock/moderator/aya", roles: ['general_manager', 'executive_manager', 'sales_manager', 'sales_moderator', 'marketing_sales_manager', 'warehouse_supervisor'] },
      { icon: Warehouse, label: "متاح نورا", path: "/warehouse-stock/moderator/noura", roles: ['general_manager', 'executive_manager', 'sales_manager', 'sales_moderator', 'marketing_sales_manager', 'warehouse_supervisor'] },
      { icon: Warehouse, label: "متاح سارة", path: "/warehouse-stock/moderator/sara", roles: ['general_manager', 'executive_manager', 'sales_manager', 'sales_moderator', 'marketing_sales_manager', 'warehouse_supervisor'] },
      { icon: Warehouse, label: "متاح منال", path: "/warehouse-stock/moderator/manal", roles: ['general_manager', 'executive_manager', 'sales_manager', 'sales_moderator', 'marketing_sales_manager', 'warehouse_supervisor'] },
      ...
      { icon: ShieldCheck, label: "مطابقة المخزون (تخطيط)", path: "/stock-reconciliation", roles: ['general_manager', 'executive_manager', 'warehouse_supervisor'] },
