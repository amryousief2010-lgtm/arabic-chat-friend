...
export const moduleSections: ModuleSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Wallet, label: "مرتجع مبيعات أعلاف", path: "/feed-factory/sales-returns", roles: ['general_manager', 'executive_manager', 'feed_factory_manager', 'accountant', 'financial_manager'] },
