...
export const moduleSections: ModuleSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: PackageCheck, label: "الرصيد الافتتاحي للمخازن", path: "/modules/warehouses/opening-balance", roles: ['general_manager', 'executive_manager', 'warehouse_supervisor'] },
      { icon: BookOpen, label: "دليل تشغيل المخزن الرئيسي", path: "/modules/warehouses/main-guide", roles: ['general_manager', 'executive_manager', 'warehouse_supervisor', 'agouza_warehouse_keeper'] },
