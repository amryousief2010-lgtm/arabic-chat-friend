...
export const moduleSections: ModuleSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Gift, label: "تكلفة وربح البوكسات", path: "/box-costs", roles: ['general_manager', 'executive_manager', 'accountant', 'financial_manager', 'sales_manager', 'marketing_sales_manager', 'meat_factory_manager'] },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: ShieldCheck, label: "الخزنة الرئيسية للشركة — أ. محمد شعلة", path: "/main-treasury", roles: ['general_manager', 'executive_manager', 'financial_manager', 'slaughterhouse_manager', 'main_treasury_accountant' as any, 'main_treasury_approver' as any] },
