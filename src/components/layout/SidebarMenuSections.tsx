...
export const moduleSections: ModuleSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Warehouse, label: "مخازن المصنع (خامات/جاهز)", path: "/feed-factory/warehouses", roles: ['general_manager', 'executive_manager', 'feed_factory_manager', 'production_manager', 'financial_manager', 'warehouse_supervisor'] },
      { icon: ShoppingCart, label: "شراء خامات + المبيعات", path: "/feed-factory/warehouses", roles: ['general_manager', 'executive_manager', 'feed_factory_manager', 'financial_manager'] },
