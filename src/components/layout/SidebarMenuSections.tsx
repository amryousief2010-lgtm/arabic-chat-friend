...
export const moduleSections: ModuleSection[] = [
  {
    ...
    items: [
      ...
      { icon: BookOpen, label: "دليل تشغيل الموظفين", path: "/operations-guide", roles: ['general_manager', 'executive_manager', 'hatchery_manager', 'farm_manager', 'brooding_manager', 'feed_factory_manager', 'meat_factory_manager', 'warehouse_supervisor', 'sales_manager', 'sales_moderator', 'marketing_sales_manager', 'production_manager','marketing_sales_viewer'] },
      { icon: LayoutDashboard, label: "لوحة التحكم", path: "/", roles: ['general_manager', 'executive_manager', 'marketing_sales_manager', 'financial_manager', 'production_manager','marketing_sales_viewer'] },
      // مخفي من السايد بار فقط - الرابط والصفحة والصلاحيات تعمل عند الفتح المباشر
      // { icon: TrendingUp, label: "اللوحات التنفيذية", path: "/executive-dashboards", roles: ['general_manager', 'executive_manager', 'sales_manager', 'marketing_sales_manager', 'financial_manager', 'accountant','marketing_sales_viewer'] },
      ...
      { icon: Bell, label: "الإشعارات", path: "/notifications", roles: ['general_manager', 'executive_manager', 'sales_manager', 'accountant', 'warehouse_supervisor', 'production_manager', 'marketing_sales_manager', 'financial_manager', 'quality_manager','marketing_sales_viewer'] },
      ...
      { icon: ScrollText, label: "سجل تدقيق حالات الطلبات", path: "/order-status-audit", roles: ['general_manager', 'executive_manager', 'sales_manager', 'accountant', 'financial_manager', 'marketing_sales_manager','marketing_sales_viewer'] },
      { icon: MessageSquare, label: "إرسال رسالة داخلية", path: "/send-message", roles: ['general_manager', 'executive_manager', 'sales_manager', 'marketing_sales_manager', 'financial_manager', 'accountant','marketing_sales_viewer'] },
    ],
  },
  {
    id: "management",
  ...
  },
  {
    ...
    items: [
      ...
      { icon: AlertTriangle, label: "أوردرات على زودكس وناقصة عندنا", path: "/modules/warehouses/zodex-missing", roles: ['general_manager', 'executive_manager', 'sales_manager', 'marketing_sales_manager', 'financial_manager', 'accountant','marketing_sales_viewer'] },
      { icon: ShieldAlert, label: "أوردرات عندنا وناقصة على زودكس", path: "/modules/warehouses/zodex-incomplete", roles: ['general_manager', 'executive_manager', 'sales_manager', 'marketing_sales_manager', 'financial_manager', 'accountant','marketing_sales_viewer'] },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: FlaskConical, label: "معمل التفريخ والحضانات", path: "/modules/hatchery-lab", roles: ['general_manager', 'executive_manager', 'hatchery_manager', 'production_manager', 'quality_manager', 'accountant', 'financial_manager', 'lab_treasury_keeper', 'lab_treasury_approver','lab_treasury_viewer'] },
  ...
  },
  {
    ...
    items: [
      ...
      { group: "مخازن مصنع اللحوم", icon: Boxes, label: "المخزون الموحد", path: "/meat-factory/unified-inventory", roles: ['general_manager', 'executive_manager', 'meat_factory_manager', 'production_manager', 'financial_manager', 'warehouse_supervisor', 'accountant', 'quality_manager'] },
    ],
  },
  {
    id: "feed-factory",
    ...
    items: [
      ...
      { group: "التصنيع والتشغيل", icon: Wheat, label: "تركيبات الأعلاف", path: "/modules/feed-factory/recipes", roles: ['general_manager', 'executive_manager', 'feed_factory_manager', 'production_manager', 'quality_manager'] },
      { group: "التصنيع والتشغيل", icon: Wheat, label: "فواتير تصنيع العلف", path: "/feed-factory/batches", roles: ['general_manager', 'executive_manager', 'feed_factory_manager', 'production_manager'] },
  ...
  },
  {
    ...
    icon: Warehouse,
    label: "9. المخازن",
    roles: ['general_manager', 'executive_manager', 'warehouse_supervisor', 'production_manager', 'quality_manager', 'sales_manager', 'sales_moderator', 'marketing_sales_manager', 'agouza_warehouse_keeper', 'meat_factory_manager', 'feed_factory_manager', 'slaughterhouse_manager', 'accountant', 'financial_manager','marketing_sales_viewer'],
    items: [
      // "المتاح في المخازن" أصبح Tab داخل صفحة "إدارة المخازن"
